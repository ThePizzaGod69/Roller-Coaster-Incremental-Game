...
function buyLengthBuyable1() {
    if (gameData.riders.gte(lengthBuyable1.cost)==true) {
        gameData.riders = gameData.riders.minus(lengthBuyable1.cost); // Take away riders
...
function buyLengthBuyable2() {
    if (gameData.riders.gte(lengthBuyable2.cost)==true) {
        gameData.riders = gameData.riders.minus(lengthBuyable2.cost); // Take away riders
...
function buyLengthBuyable3() {
    if (gameData.riders.gte(lengthBuyable3.cost)==true) {
        gameData.riders = gameData.riders.minus(lengthBuyable3.cost); // Take away riders
...
function buyLengthBuyable4() {
    if (gameData.riders.gte(lengthBuyable4.cost)==true) {
        gameData.riders = gameData.riders.minus(lengthBuyable4.cost); // Take away riders
